...
# ==============================================================================
# 1. DADOS DO CENÁRIO INICIAL (ATUALIZADOS - NOVO VALOR CANADÁ)
# ==============================================================================
DADOS_CENARIO_INICIAL = [
    # Pais       | Ferr(X) | Rod(Y) | Aqua(Size)
    ('Alemanha',   20.0,     60.0,    20.0),
    ('Brasil',     20.0,     65.0,    15.0),
    ('França',     20.0,     75.0,    5.0),
    ('Belgica',    15.0,     65.0,    20.0),
    ('Dinamarca',  10.0,     80.0,    10.0),
    ('Hungria',    30.0,     60.0,    10.0),
    ('USA',        45.0,     35.0,    20.0),
    ('China',      40.0,     15.0,    45.0),
    ('Canada',     67.5,     22.5,    10.0), # Valor atualizado conforme solicitado
...
# ==============================================================================
# 2. DADOS REAIS (2014-2023) - EXTRAÍDOS DA PLANILHA DO USUÁRIO
# ==============================================================================

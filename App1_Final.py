...
# --- METODOLOGIA (RESTAURADA E EXPANDIDA) ---
with st.expander("📘 Metodologia e Fontes de Dados (Clique para abrir)"):
    ...
    * **Europa (Eurostat):** [Dataset: tran_hv_frmod](https://ec.europa.eu/eurostat/databrowser/view/tran_hv_frmod)
    * **Brasil:** EPL / Ministério dos Transportes (Anuários Estatísticos)
    * **EUA:** Bureau of Transportation Statistics (BTS)
    * **China:** National Bureau of Statistics of China (NBSC)
    
    **Fontes dos Países Adicionais:**
    * **México:** [SCT / INEGI - Estadística Básica](https://www.gob.mx/sct/acciones-y-programas/estadistica-basica-del-autotransporte-federal)
    * **Turquia:** [TurkStat - Transportation Statistics](https://data.tuik.gov.tr/Kategori/GetKategori?p=Ulastirma-ve-Haberlesme-112)
    * **Chile:** [INE Chile / OECD Data](https://data.oecd.org/transport/freight-transport.htm)
    * **Noruega:** [SSB - Domestic Transport](https://www.ssb.no/en/transport-og-reiseliv/landtransport/statistikk/innenlandsk-transport)
    """)
...
cores_paises = {
    ...
    'Brasil': '#009739', 
    'Canadá': '#FF0000', 
    'China': '#DAA520',   # ALTERADO: Goldenrod (Dourado/Mostarda) para diferenciar do Canadá
    'Dinamarca': '#C8102E', 
    'EUA': '#002868', 
    'França': '#002395', 
    'Hungria': '#436F4D', 
...
with col_slider:
    ...
    # USO DE KEY PARA VINCULAR AO ESTADO (CORRIGE O BUG DO BOTÃO)
...
if not df_plot.empty:
    ...
    # EIXOS E LEGENDAS MAIS CLAROS COM DTICK=10 (CORRIGIDO)
    fig.update_layout(
    ...
    # REMOVIDA A LINHA PONTILHADA DIAGONAL
    # fig.add_shape(...) -> DELETADO

...
# --- ESTILIZAÇÃO CSS (CORRIGIDA PARA LETRA BRANCA NA DICA) ---
st.markdown("""
<style>
    ...
    /* CORREÇÃO DA CAIXA DE DICA (st.info) */
    /* Força o fundo azul escuro e o texto branco para contraste */
    .stAlert {
        background-color: #00529B !important; /* Azul Forte */
...
with st.expander("📘 Metodologia e Fontes de Dados (Clique para abrir)"):
    ...
    **Como os dados foram obtidos?**
    ...
    Esta métrica multiplica a carga transportada (toneladas) pela distância percorrida (km), sendo o padrão internacional para medir desempenho logístico.
    ...
    **Fontes Oficiais:**
    * **Europa:** Eurostat (Dataset: `tran_hv_frmod`)
    * **Brasil:** EPL / Ministério dos Transportes
    * **EUA:** Bureau of Transportation Statistics (BTS)
    * **Austrália:** BITRE (Infrastructure Statistics Yearbook)
    * **Outros:** Agências nacionais de estatística (Japão MLIT, China NBSC, etc.)
    """)
...
cores_paises = {
    ...
    # Novos Adicionais (Atualizado)
    'República Tcheca': '#11457e', 'Polônia': '#dc143c', 'Mexico': '#006847',
...
# DADOS COMPLETOS (BASE FINAL + ADICIONAL CONSOLIDADA)
...
Bulgaria,Ferroviario - Freight transport,0.182,0.179,0.171,0.186,0.193,0.212,0.207,0.196,0.229,0.191
Bulgaria,Rodoviario -  Freight transport,0.549,0.547,0.556,0.565,0.562,0.468,0.505,0.56,0.605,0.63
Bulgaria,Aquaviario -  Freight transport,0.269,0.274,0.273,0.249,0.245,0.32,0.288,0.244,0.166,0.179
Croatia,Ferroviario - Freight transport,0.204,0.194,0.191,0.213,0.215,0.241,0.253,0.238,0.258,0.227
Croatia,Rodoviario -  Freight transport,0.727,0.728,0.735,0.72,0.731,0.69,0.677,0.699,0.698,0.737
Croatia,Aquaviario -  Freight transport,0.069,0.078,0.074,0.067,0.054,0.069,0.07,0.063,0.044,0.036
Luxembourg,Ferroviario - Freight transport,0.061,0.071,0.065,0.068,0.081,0.069,0.068,0.065,0.062,0.073
Luxembourg,Rodoviario -  Freight transport,0.855,0.849,0.873,0.87,0.844,0.85,0.851,0.855,0.863,0.857
Luxembourg,Aquaviario -  Freight transport,0.084,0.08,0.062,0.062,0.075,0.081,0.081,0.08,0.075,0.07
Netherlands,Ferroviario - Freight transport,0.059,0.062,0.061,0.061,0.065,0.064,0.062,0.064,0.066,0.064
Netherlands,Rodoviario -  Freight transport,0.486,0.492,0.502,0.498,0.51,0.517,0.528,0.52,0.523,0.528
Netherlands,Aquaviario -  Freight transport,0.455,0.446,0.437,0.441,0.425,0.419,0.41,0.416,0.411,0.408
Austria,Ferroviario - Freight transport,0.331,0.326,0.321,0.319,0.316,0.31,0.298,0.3,0.303,0.293
Austria,Rodoviario -  Freight transport,0.634,0.647,0.649,0.65,0.663,0.665,0.679,0.68,0.68,0.69
Austria,Aquaviario -  Freight transport,0.035,0.027,0.03,0.031,0.021,0.025,0.023,0.02,0.017,0.017
Romania,Ferroviario - Freight transport,0.302,0.316,0.304,0.302,0.289,0.268,0.258,0.253,0.255,0.24
Romania,Rodoviario -  Freight transport,0.408,0.38,0.402,0.425,0.441,0.45,0.455,0.497,0.54,0.537
Romania,Aquaviario -  Freight transport,0.29,0.304,0.294,0.273,0.27,0.282,0.287,0.25,0.205,0.223
Slovakia,Ferroviario - Freight transport,0.389,0.366,0.346,0.33,0.326,0.31,0.286,0.322,0.304,0.304
Slovakia,Rodoviario -  Freight transport,0.571,0.602,0.617,0.634,0.643,0.654,0.68,0.645,0.67,0.67
Slovakia,Aquaviario -  Freight transport,0.04,0.032,0.037,0.036,0.031,0.036,0.034,0.033,0.026,0.026
Azerbaijan,Ferroviario - Freight transport,0.283,0.252,0.215,0.183,0.173,0.198,0.287,0.298,0.32,0.29
Azerbaijan,Rodoviario -  Freight transport,0.558,0.63,0.661,0.643,0.651,0.674,0.518,0.529,0.525,0.536
Azerbaijan,Aquaviario -  Freight transport,0.159,0.118,0.124,0.174,0.176,0.128,0.195,0.173,0.155,0.174
Serbia,Ferroviario - Freight transport,0.446,0.459,0.372,0.366,0.313,0.244,0.249,0.2,0.201,0.166
Serbia,Rodoviario -  Freight transport,0.441,0.419,0.517,0.553,0.631,0.695,0.701,0.675,0.688,0.719
Serbia,Aquaviario -  Freight transport,0.113,0.122,0.111,0.081,0.056,0.061,0.05,0.125,0.111,0.115
...
Mexico,Ferroviario - Freight transport,0.275,0.272,0.26,0.262,0.254,0.251,0.261,0.268,0.267,0.258
Mexico,Rodoviario -  Freight transport,0.745,0.748,0.753,0.748,0.749,0.752,0.761,0.758,0.748,0.742
Mexico,Aquaviario -  Freight transport,0.046,0.045,0.038,0.046,0.047,0.046,0.041,0.038,0.046,0.044
...
selecao_adicional = st.sidebar.multiselect(
    ...
    default=[], 
    disabled=is_inicial  # BLOQUEIA O COMPONENTE
)

# --- AVISO DE BAIXA PORCENTAGEM AQUAVIÁRIA (NOVA LÓGICA) ---
paises_com_aviso_aquaviario = ['Polônia', 'República Tcheca']
# Verifica quais países da lista de aviso foram selecionados pelo usuário
...
with col_slider:
    ...
    st.session_state.slider_principal = st.select_slider("Linha do Tempo:", options=opcoes, value=st.session_state.slider_principal)

...
# ==============================================================================
# 2. METODOLOGIA (COMPLETA E AJUSTADA)
# ==============================================================================
with st.expander("📘 Metodologia e Fontes de Dados (Clique para abrir)"):
    ...
    * **Série Histórica (2014-2023):** Dados reais extraídos de relatórios governamentais e institutos de estatística (Eurostat, EPL, BTS, NBSC, Rosstat).
    ...
    * **Por que usar:** É superior à simples medição de peso (toneladas) ou valor (dólares), pois pondera a distância percorrida, refletindo com precisão o verdadeiro esforço logístico e o consumo de infraestrutura.
...
# Lista Principal de Países (Definida AQUI para evitar erro NameError)
...
# Dados do Cenário Inicial (Benchmark Estimado)

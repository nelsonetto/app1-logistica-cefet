...
cores_paises = {
    # Principais
    'Brasil': '#009739', 'China': '#DE2910', 'EUA': '#002868', 'Alemanha': '#FFCE00',
    'Rússia': '#FF8C00', 'França': '#002395', 'Canadá': '#FF0000', 'Bélgica': '#000000',
    'Dinamarca': '#C8102E', 'Hungria': '#436F4D',
    # Adicionais
    'Bulgária': '#e408c2', 'Croácia': '#183c9e', 'Luxemburgo': '#d0970b', 
    'Holanda': '#fa3d56', 'Áustria': '#944d33', 'Romênia': '#8e83b0', 
    'Eslováquia': '#94152a', 'Azerbaijão': '#5cefcb', 'Sérvia': '#a3d636', 
...
# Listas de Controle (PT-BR)
PAISES_PRINCIPAIS = [
    'Alemanha', 'Brasil', 'França', 'Bélgica', 'Dinamarca', 
    'Hungria', 'EUA', 'China', 'Canadá', 'Rússia'
]

# ==============================================================================
# 1. DADOS DO CENÁRIO INICIAL (PT-BR)
# ==============================================================================

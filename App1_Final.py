...
# --- DEFINIÇÃO DE CORES FIXAS POR PAÍS ---
cores_paises = {
    'Brasil': '#009739',      # Verde Bandeira
    'China': '#DE2910',       # Vermelho
    'USA': '#002868',         # Azul Marinho
    'Alemanha': '#FFCE00',    # Amarelo Ouro
    'Russia': '#FF8C00',      # Laranja (Alterado de Branco para visibilidade)
    'França': '#002395',      # Azul Royal
    'Canada': '#FF0000',      # Vermelho Brilhante
    'Belgica': '#000000',     # Preto
    'Dinamarca': '#C8102E',   # Vermelho Escuro
    'Hungria': '#436F4D'      # Verde Musgo
}

# ==============================================================================
# 1. DADOS DO CENÁRIO INICIAL
# ==============================================================================
...
# --- 5. GRÁFICO ---
df_plot = df[df['Ano'].astype(str) == st.session_state.slider_principal]
titulo = "Cenário Inicial" if st.session_state.slider_principal == "Inicial" else f"Matriz de Transportes ({st.session_state.slider_principal})"
...
if not df_plot.empty:
    ...
    fig.update_xaxes(dtick=10); fig.update_yaxes(dtick=10)

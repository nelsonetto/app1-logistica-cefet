...
# Seleção Multiselect - LISTA ORDENADA
...
# Lista final para o gráfico - ORDENADA ALFABETICAMENTE
# Isso garante que a legenda do gráfico siga a ordem alfabética A-Z
paises_para_mostrar = sorted(PAISES_PRINCIPAIS + selecao_adicional)

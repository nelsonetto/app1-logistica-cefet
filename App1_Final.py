...
# --- DEFINIÇÃO DE CORES (PRINCIPAIS + ADICIONAIS) ---
cores_paises = {
    # Principais
    'Brasil': '#009739', 'China': '#DE2910', 'USA': '#002868', 'Alemanha': '#FFCE00',
    'Russia': '#FF8C00', 'França': '#002395', 'Canada': '#FF0000', 'Belgica': '#000000',
    'Dinamarca': '#C8102E', 'Hungria': '#436F4D',
    # Adicionais (Cores distintas geradas para evitar repetição)
    'Bulgaria': '#e408c2', 'Croatia': '#183c9e', 'Luxembourg': '#d0970b', 
    'Netherlands': '#fa3d56', 'Austria': '#944d33', 'Romania': '#8e83b0', 
    'Slovakia': '#94152a', 'Azerbaijan': '#5cefcb', 'Serbia': '#a3d636', 
    'Japão': '#9e96e7', 'Austrália': '#2e8ec1', 'Coreia do Sul': '#a0e6c9', 
    'Colômbia': '#561827', 'Reino Unido': '#0792fa', 'Itália': '#831a10', 
    'Espanha': '#ab7538', 'Vietnã': '#4a110b', 'Suécia': '#b7bb68', 
    'Finlândia': '#0f8d9f', 'Argentina': '#d8ccdd'
}

# Listas de Controle
PAISES_PRINCIPAIS = [
    'Alemanha', 'Brasil', 'França', 'Belgica', 'Dinamarca', 
    'Hungria', 'USA', 'China', 'Canada', 'Russia'
]

# ==============================================================================
# 1. DADOS DO CENÁRIO INICIAL (Mantido original para os principais)
# ==============================================================================
DADOS_CENARIO_INICIAL = [
    ('Alemanha', 17.5, 65.0, 17.5),
    ('Brasil', 20.0, 67.5, 12.5),
    ('França', 20.0, 75.0, 5.0),
    ('Belgica', 15.0, 75.0, 10.0),
...
# ==============================================================================
# 2. DADOS REAIS (2014-2023) - Base Completa (Principais + Adicionais)
# ==============================================================================
...
Bulgaria,Ferroviario - Freight transport,0.182,0.179,0.171,0.186,0.193,0.212,0.207,0.196,0.228,0.191
Bulgaria,Rodoviario -  Freight transport,0.548,0.547,0.556,0.565,0.562,0.467,0.505,0.56,0.605,0.63
Bulgaria,Aquaviario -  Freight transport,0.268,0.273,0.273,0.249,0.245,0.32,0.288,0.244,0.166,0.179
Croatia,Ferroviario - Freight transport,0.204,0.193,0.191,0.213,0.215,0.241,0.253,0.238,0.258,0.226
Croatia,Rodoviario -  Freight transport,0.727,0.728,0.735,0.72,0.731,0.69,0.677,0.699,0.698,0.737
Croatia,Aquaviario -  Freight transport,0.069,0.078,0.074,0.067,0.053,0.069,0.07,0.063,0.044,0.036
Luxembourg,Ferroviario - Freight transport,0.061,0.071,0.065,0.068,0.081,0.069,0.067,0.065,0.062,0.073
...
Austria,Ferroviario - Freight transport,0.331,0.325,0.321,0.319,0.316,0.31,0.298,0.3,0.302,0.293
Austria,Rodoviario -  Freight transport,0.634,0.647,0.649,0.650,0.662,0.665,0.679,0.68,0.680,0.69
Austria,Aquaviario -  Freight transport,0.035,0.027,0.03,0.03,0.021,0.025,0.023,0.02,0.017,0.017
Romania,Ferroviario - Freight transport,0.302,0.316,0.303,0.302,0.289,0.268,0.258,0.253,0.255,0.24
Romania,Rodoviario -  Freight transport,0.408,0.38,0.402,0.424,0.441,0.45,0.455,0.497,0.54,0.537
Romania,Aquaviario -  Freight transport,0.29,0.304,0.294,0.273,0.271,0.282,0.287,0.25,0.205,0.223
Slovakia,Ferroviario - Freight transport,0.389,0.366,0.346,0.33,0.326,0.31,0.286,0.321,0.304,0.304
...
Azerbaijan,Ferroviario - Freight transport,0.283,0.251,0.214,0.182,0.173,0.197,0.286,0.298,0.320,0.290
Azerbaijan,Rodoviario -  Freight transport,0.558,0.630,0.660,0.643,0.650,0.673,0.518,0.528,0.524,0.535
Azerbaijan,Aquaviario -  Freight transport,0.158,0.117,0.124,0.174,0.176,0.128,0.194,0.173,0.155,0.174
Serbia,Ferroviario - Freight transport,0.445,0.458,0.371,0.365,0.312,0.243,0.248,0.199,0.200,0.165
Serbia,Rodoviario -  Freight transport,0.441,0.419,0.517,0.553,0.631,0.694,0.701,0.675,0.688,0.718
Serbia,Aquaviario -  Freight transport,0.113,0.122,0.111,0.080,0.056,0.061,0.050,0.125,0.111,0.115
...
paises_adicionais_disponiveis = [p for p in todos_os_paises if p not in PAISES_PRINCIPAIS]

# Seleção Multiselect
selecao_adicional = st.sidebar.multiselect(
    "Adicionar Outros Países:", 
    options=sorted(paises_adicionais_disponiveis),
    default=[] # Começa vazio (apenas principais visíveis)
)

# Lista final para o gráfico
paises_para_mostrar = PAISES_PRINCIPAIS + selecao_adicional
